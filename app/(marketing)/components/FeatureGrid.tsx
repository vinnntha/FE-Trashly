    ...
    <section id="fitur" className="py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-7 group relative overflow-hidden rounded-3xl min-h-[380px] sm:min-h-[420px] flex flex-col justify-between p-7 sm:p-8 border border-[#0B636B]/15 shadow-sm">
            <Image
          ...
          <div className="md:col-span-5 rounded-3xl p-7 bg-[#0B636B] text-[#EFF0EB] flex flex-col justify-between border border-white/10 shadow-sm relative overflow-hidden group">
            {/* Ambient subtle glow */}
          ...
          <div className="md:col-span-5 rounded-3xl p-7 bg-white border border-[#0B636B]/15 text-[#0B636B] flex flex-col justify-between shadow-xs">
            <div>
          ...
          <div className="md:col-span-7 rounded-3xl p-7 bg-[#CFE26C]/30 border border-[#64B60A]/20 text-[#0B636B] flex flex-col justify-between shadow-xs">
            <div>
              <div className="flex items-center justify-between mb-5">
